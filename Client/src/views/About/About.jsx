    ...
    return (
        <>
            <NavLink to="/products" className="LinkAbout">
                <Image className='imageAbout' src="carrousel3.jpg" fluid alt='cuarto_banner' />
            </NavLink>
            <div className='BoxAboutAll'>
                <div className='BoxAbout1'>
                    <Image alt='productos artesanales' className='imageAbout1' fluid src='/MezclaAbout.jpg' />
                ...
                <div className='BoxAbout2'>
                    <Image alt='productos de la mejor calidad' className='imageAbout1' fluid src='/carousel1.webp' />
                ...
                <div className='BoxAbout1'>
                    <Image alt='productos que no dañan el medio ambiente' className='imageAbout1' fluid src='/carrousel2.jpg' />
                    <div className='BoxAboutDesc1'>
                ...
                <div className='BoxAbout2'>
                    <Image alt='indian & Co' className='imageAbout1' fluid src='/AboutAbout.jpg' />
                    <div className='BoxAboutDesc2'>
