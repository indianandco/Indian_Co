        ...
        <div className='containerCards'>
            <Card className="mx-4 my-4 customCard">
                ...
                <ListGroup className="list-group-flush align-items-center">
                    <Button className="border-0 rounded-0 addToCart" style={{ width: '100%' }} variant="outline-success" size="lg"><NavLink to={`/detail/${_id}`} className="nav-link no-underline">Agregar al carrito</NavLink></Button>
                </ListGroup>
