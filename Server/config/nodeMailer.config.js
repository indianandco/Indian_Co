...
const shopOrderMailMP = async (email, name, code, amount) => {
  await transport.sendMail({
...
const shopOrderMailTransferWShipping = async (
  email,
  name,
  code,
  amount,
        ...
        <div class="container">
            ...
            <div class="cuadro">
               <p><b>Número de Pedido:</b> ${code}</p>
                ...
                <p><b>Producto(s) Adquirido(s):${generateProductList(cart)}
            ...
            <div class="cuadro">
                <p><b>Banco:</b> [Nombre del Banco]</p>
                <p><b>Número de Cuenta:</b> [Número de Cuenta]</p>
                <p><b>Titular de la Cuenta:</b> [Nombre del Titular de la Cuenta]</p>
