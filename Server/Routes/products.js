...
} = require("../Handlers/get/getProductByIdHandler");
const {
  getProductByCategoryHandler,
} = require("../Handlers/get/getProductByCategoryHandler");
const {
  getProductByTitleHandler,
} = require("../Handlers/get/getProductByTitleHandler");
const {
  deleteProductByIdHandler,
} = require("../Handlers/delete/deleteProductByIdHandler");
